...
package com.liferay.portlet.ratings.service.convert.database;
 ...
 * @generated
 */
public class RatingsDatabaseConverter implements DatabaseConverter {
	@Override
	...
	private List<Class<?extends BaseModel<?>>> _getModels() {
		...
		models.add(RatingsEntryImpl.class);
		models.add(RatingsStatsImpl.class);
