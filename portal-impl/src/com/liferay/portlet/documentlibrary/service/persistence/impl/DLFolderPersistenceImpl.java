...
public class DLFolderPersistenceImpl extends BasePersistenceImpl<DLFolder>
	...
	public long[] getDLFileEntryTypePrimaryKeys(long pk) {
		long[] pks = dlFolderToDLFileEntryTypeTableMapper.getRightPrimaryKeys(getCompanyIdFromPK(
					pk), pk);
	...
	public List<com.liferay.portlet.documentlibrary.model.DLFileEntryType> getDLFileEntryTypes(
		...
		return dlFolderToDLFileEntryTypeTableMapper.getRightBaseModels(getCompanyIdFromPK(
	...
	public boolean containsDLFileEntryType(long pk, long dlFileEntryTypePK) {
		return dlFolderToDLFileEntryTypeTableMapper.containsTableMapping(getCompanyIdFromPK(
				pk), pk, dlFileEntryTypePK);
	}
	...
	public void addDLFileEntryType(long pk, long dlFileEntryTypePK) {
		dlFolderToDLFileEntryTypeTableMapper.addTableMapping(getCompanyIdFromPK(
				pk), pk, dlFileEntryTypePK);
	}
	...
	public void addDLFileEntryType(long pk,
		...
		dlFolderToDLFileEntryTypeTableMapper.addTableMapping(getCompanyIdFromPK(
				pk), pk, dlFileEntryType.getPrimaryKey());
	}
	...
	public void clearDLFileEntryTypes(long pk) {
		dlFolderToDLFileEntryTypeTableMapper.deleteLeftPrimaryKeyTableMappings(getCompanyIdFromPK(
				pk), pk);
	}
	...
	public void removeDLFileEntryType(long pk, long dlFileEntryTypePK) {
		dlFolderToDLFileEntryTypeTableMapper.deleteTableMapping(getCompanyIdFromPK(
				pk), pk, dlFileEntryTypePK);
	}
	...
	*/
	protected long getCompanyIdFromPK(long pk) {
		...
		if (dlFolder == null) {
			throw new RuntimeException("The entity DLFolder with PK " + pk +
				" was not found");
		}
