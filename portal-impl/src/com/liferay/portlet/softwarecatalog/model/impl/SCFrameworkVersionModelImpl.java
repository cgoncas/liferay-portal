...
public class SCFrameworkVersionModelImpl extends BaseModelImpl<SCFrameworkVersion>
	...
	public static final String TABLE_SQL_CREATE = "create table SCFrameworkVersion (companyId LONG,frameworkVersionId LONG not null primary key,groupId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,url STRING null,active_ BOOLEAN,priority INTEGER)";
