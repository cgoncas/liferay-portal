...
public class SCProductEntryPersistenceImpl extends BasePersistenceImpl<SCProductEntry>
	...
	public long[] getSCLicensePrimaryKeys(long pk) {
		long[] pks = scProductEntryToSCLicenseTableMapper.getRightPrimaryKeys(getCompanyIdFromPK(
					pk), pk);
	...
	public List<com.liferay.portlet.softwarecatalog.model.SCLicense> getSCLicenses(
		...
		return scProductEntryToSCLicenseTableMapper.getRightBaseModels(getCompanyIdFromPK(
	...
	public boolean containsSCLicense(long pk, long scLicensePK) {
		return scProductEntryToSCLicenseTableMapper.containsTableMapping(getCompanyIdFromPK(
				pk), pk, scLicensePK);
	}
	...
	public void addSCLicense(long pk, long scLicensePK) {
		scProductEntryToSCLicenseTableMapper.addTableMapping(getCompanyIdFromPK(
				pk), pk, scLicensePK);
	}
	...
	public void clearSCLicenses(long pk) {
		scProductEntryToSCLicenseTableMapper.deleteLeftPrimaryKeyTableMappings(getCompanyIdFromPK(
				pk), pk);
	}
	...
	public void removeSCLicense(long pk, long scLicensePK) {
		scProductEntryToSCLicenseTableMapper.deleteTableMapping(getCompanyIdFromPK(
				pk), pk, scLicensePK);
	}
	...
	*/
	protected long getCompanyIdFromPK(long pk) {
		...
		if (scProductEntry == null) {
			throw new RuntimeException("The entity SCProductEntry with PK " +
				pk + " was not found");
		}
