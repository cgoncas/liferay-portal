...
public class AssetCategoryPersistenceImpl extends BasePersistenceImpl<AssetCategory>
	...
	public long[] getAssetEntryPrimaryKeys(long pk) {
		long[] pks = assetCategoryToAssetEntryTableMapper.getRightPrimaryKeys(getCompanyIdFromPK(
					pk), pk);
	...
	public List<com.liferay.portlet.asset.model.AssetEntry> getAssetEntries(
		...
		return assetCategoryToAssetEntryTableMapper.getRightBaseModels(getCompanyIdFromPK(
	...
	public boolean containsAssetEntry(long pk, long assetEntryPK) {
		return assetCategoryToAssetEntryTableMapper.containsTableMapping(getCompanyIdFromPK(
				pk), pk, assetEntryPK);
	}
	...
	public void addAssetEntry(long pk, long assetEntryPK) {
		assetCategoryToAssetEntryTableMapper.addTableMapping(getCompanyIdFromPK(
				pk), pk, assetEntryPK);
	}
	...
	public void addAssetEntry(long pk,
		...
		assetCategoryToAssetEntryTableMapper.addTableMapping(getCompanyIdFromPK(
				pk), pk, assetEntry.getPrimaryKey());
	}
	...
	public void clearAssetEntries(long pk) {
		assetCategoryToAssetEntryTableMapper.deleteLeftPrimaryKeyTableMappings(getCompanyIdFromPK(
				pk), pk);
	}
	...
	public void removeAssetEntry(long pk, long assetEntryPK) {
		assetCategoryToAssetEntryTableMapper.deleteTableMapping(getCompanyIdFromPK(
				pk), pk, assetEntryPK);
	}
	...
	*/
	protected long getCompanyIdFromPK(long pk) {
		...
		if (assetCategory == null) {
			throw new RuntimeException("The entity AssetCategory with PK " +
				pk + " was not found");
		}
