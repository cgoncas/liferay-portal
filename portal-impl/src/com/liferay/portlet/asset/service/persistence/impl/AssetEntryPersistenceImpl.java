...
public class AssetEntryPersistenceImpl extends BasePersistenceImpl<AssetEntry>
	...
	public long[] getAssetCategoryPrimaryKeys(long pk) {
		long[] pks = assetEntryToAssetCategoryTableMapper.getRightPrimaryKeys(getCompanyIdFromPK(
					pk), pk);
	...
	public List<com.liferay.portlet.asset.model.AssetCategory> getAssetCategories(
		...
		return assetEntryToAssetCategoryTableMapper.getRightBaseModels(getCompanyIdFromPK(
	...
	public boolean containsAssetCategory(long pk, long assetCategoryPK) {
		return assetEntryToAssetCategoryTableMapper.containsTableMapping(getCompanyIdFromPK(
				pk), pk, assetCategoryPK);
	}
	...
	public void addAssetCategory(long pk, long assetCategoryPK) {
		assetEntryToAssetCategoryTableMapper.addTableMapping(getCompanyIdFromPK(
				pk), pk, assetCategoryPK);
	}
	...
	public void addAssetCategory(long pk,
		...
		assetEntryToAssetCategoryTableMapper.addTableMapping(getCompanyIdFromPK(
				pk), pk, assetCategory.getPrimaryKey());
	}
	...
	public void clearAssetCategories(long pk) {
		assetEntryToAssetCategoryTableMapper.deleteLeftPrimaryKeyTableMappings(getCompanyIdFromPK(
				pk), pk);
	}
	...
	public void removeAssetCategory(long pk, long assetCategoryPK) {
		assetEntryToAssetCategoryTableMapper.deleteTableMapping(getCompanyIdFromPK(
				pk), pk, assetCategoryPK);
	}
	...
	public long[] getAssetTagPrimaryKeys(long pk) {
		long[] pks = assetEntryToAssetTagTableMapper.getRightPrimaryKeys(getCompanyIdFromPK(
					pk), pk);
	...
	public List<com.liferay.portlet.asset.model.AssetTag> getAssetTags(
		...
		return assetEntryToAssetTagTableMapper.getRightBaseModels(getCompanyIdFromPK(
				pk), pk, start, end, orderByComparator);
	}
	...
	public boolean containsAssetTag(long pk, long assetTagPK) {
		return assetEntryToAssetTagTableMapper.containsTableMapping(getCompanyIdFromPK(
				pk), pk, assetTagPK);
	}
	...
	public void addAssetTag(long pk, long assetTagPK) {
		assetEntryToAssetTagTableMapper.addTableMapping(getCompanyIdFromPK(pk),
			pk, assetTagPK);
	}
	...
	public void clearAssetTags(long pk) {
		assetEntryToAssetTagTableMapper.deleteLeftPrimaryKeyTableMappings(getCompanyIdFromPK(
				pk), pk);
	}
	...
	public void removeAssetTag(long pk, long assetTagPK) {
		assetEntryToAssetTagTableMapper.deleteTableMapping(getCompanyIdFromPK(
				pk), pk, assetTagPK);
	}
	...
	*/
	protected long getCompanyIdFromPK(long pk) {
		...
		if (assetEntry == null) {
			throw new RuntimeException("The entity AssetEntry with PK " + pk +
				" was not found");
		}
