...
public class AssetTagPersistenceImpl extends BasePersistenceImpl<AssetTag>
	...
	public long[] getAssetEntryPrimaryKeys(long pk) {
		long[] pks = assetTagToAssetEntryTableMapper.getRightPrimaryKeys(getCompanyIdFromPK(
					pk), pk);
	...
	public List<com.liferay.portlet.asset.model.AssetEntry> getAssetEntries(
		...
		return assetTagToAssetEntryTableMapper.getRightBaseModels(getCompanyIdFromPK(
	...
	public boolean containsAssetEntry(long pk, long assetEntryPK) {
		return assetTagToAssetEntryTableMapper.containsTableMapping(getCompanyIdFromPK(
				pk), pk, assetEntryPK);
	}
	...
	public void addAssetEntry(long pk, long assetEntryPK) {
		assetTagToAssetEntryTableMapper.addTableMapping(getCompanyIdFromPK(pk),
			pk, assetEntryPK);
	}
	...
	public void clearAssetEntries(long pk) {
		assetTagToAssetEntryTableMapper.deleteLeftPrimaryKeyTableMappings(getCompanyIdFromPK(
				pk), pk);
	}
	...
	public void removeAssetEntry(long pk, long assetEntryPK) {
		assetTagToAssetEntryTableMapper.deleteTableMapping(getCompanyIdFromPK(
				pk), pk, assetEntryPK);
	}
	...
	*/
	protected long getCompanyIdFromPK(long pk) {
		...
		if (assetTag == null) {
			throw new RuntimeException("The entity AssetTag with PK " + pk +
				" was not found");
		}
