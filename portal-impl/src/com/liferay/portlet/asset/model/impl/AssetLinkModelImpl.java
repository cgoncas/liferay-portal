...
public class AssetLinkModelImpl extends BaseModelImpl<AssetLink>
	...
	public static final String TABLE_SQL_CREATE = "create table AssetLink (companyId LONG,linkId LONG not null primary key,userId LONG,userName VARCHAR(75) null,createDate DATE null,entryId1 LONG,entryId2 LONG,type_ INTEGER,weight INTEGER)";
