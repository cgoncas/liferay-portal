...
package com.liferay.portlet.exportimport.service.convert.database;
 ...
 * @generated
 */
public class ExportImportDatabaseConverter implements DatabaseConverter {
	@Override
	...
	private List<Class<?extends BaseModel<?>>> _getModels() {
		...
		models.add(ExportImportConfigurationImpl.class);
