...
package com.liferay.portlet.blogs.service.convert.database;
 ...
 * @generated
 */
public class BlogsDatabaseConverter implements DatabaseConverter {
	@Override
	...
	private List<Class<?extends BaseModel<?>>> _getModels() {
		...
		models.add(BlogsEntryImpl.class);
		models.add(BlogsStatsUserImpl.class);
