...
public class TeamPersistenceImpl extends BasePersistenceImpl<Team>
	...
	public long[] getUserPrimaryKeys(long pk) {
		long[] pks = teamToUserTableMapper.getRightPrimaryKeys(getCompanyIdFromPK(
					pk), pk);
	...
	public List<com.liferay.portal.model.User> getUsers(long pk, int start,
		...
		return teamToUserTableMapper.getRightBaseModels(getCompanyIdFromPK(pk),
	...
	public boolean containsUser(long pk, long userPK) {
		return teamToUserTableMapper.containsTableMapping(getCompanyIdFromPK(pk),
			pk, userPK);
	}
	...
	public void addUser(long pk, long userPK) {
		teamToUserTableMapper.addTableMapping(getCompanyIdFromPK(pk), pk, userPK);
	}
	...
	public void addUser(long pk, com.liferay.portal.model.User user) {
		teamToUserTableMapper.addTableMapping(getCompanyIdFromPK(pk), pk,
			user.getPrimaryKey());
	}
	...
	public void clearUsers(long pk) {
		teamToUserTableMapper.deleteLeftPrimaryKeyTableMappings(getCompanyIdFromPK(
				pk), pk);
	}
	...
	public void removeUser(long pk, long userPK) {
		teamToUserTableMapper.deleteTableMapping(getCompanyIdFromPK(pk), pk,
			userPK);
	}
	...
	public long[] getUserGroupPrimaryKeys(long pk) {
		long[] pks = teamToUserGroupTableMapper.getRightPrimaryKeys(getCompanyIdFromPK(
					pk), pk);
	...
	public List<com.liferay.portal.model.UserGroup> getUserGroups(long pk,
		...
		return teamToUserGroupTableMapper.getRightBaseModels(getCompanyIdFromPK(
	...
	public boolean containsUserGroup(long pk, long userGroupPK) {
		return teamToUserGroupTableMapper.containsTableMapping(getCompanyIdFromPK(
				pk), pk, userGroupPK);
	}
	...
	public void addUserGroup(long pk, long userGroupPK) {
		teamToUserGroupTableMapper.addTableMapping(getCompanyIdFromPK(pk), pk,
			userGroupPK);
	}
	...
	public void clearUserGroups(long pk) {
		teamToUserGroupTableMapper.deleteLeftPrimaryKeyTableMappings(getCompanyIdFromPK(
				pk), pk);
	}
	...
	public void removeUserGroup(long pk, long userGroupPK) {
		teamToUserGroupTableMapper.deleteTableMapping(getCompanyIdFromPK(pk),
			pk, userGroupPK);
	}
	...
	*/
	protected long getCompanyIdFromPK(long pk) {
		...
		if (team == null) {
			throw new RuntimeException("The entity Team with PK " + pk +
				" was not found");
		}
