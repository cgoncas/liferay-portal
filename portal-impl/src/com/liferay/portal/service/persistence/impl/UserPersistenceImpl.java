...
public class UserPersistenceImpl extends BasePersistenceImpl<User>
	...
	public long[] getGroupPrimaryKeys(long pk) {
		long[] pks = userToGroupTableMapper.getRightPrimaryKeys(getCompanyIdFromPK(
					pk), pk);
	...
	public List<com.liferay.portal.model.Group> getGroups(long pk, int start,
		...
		return userToGroupTableMapper.getRightBaseModels(getCompanyIdFromPK(pk),
	...
	public boolean containsGroup(long pk, long groupPK) {
		return userToGroupTableMapper.containsTableMapping(getCompanyIdFromPK(
				pk), pk, groupPK);
	}
	...
	public void addGroup(long pk, long groupPK) {
		userToGroupTableMapper.addTableMapping(getCompanyIdFromPK(pk), pk,
			groupPK);
	}
	...
	public void clearGroups(long pk) {
		userToGroupTableMapper.deleteLeftPrimaryKeyTableMappings(getCompanyIdFromPK(
				pk), pk);
	}
	...
	public void removeGroup(long pk, long groupPK) {
		userToGroupTableMapper.deleteTableMapping(getCompanyIdFromPK(pk), pk,
			groupPK);
	}
	...
	public long[] getOrganizationPrimaryKeys(long pk) {
		long[] pks = userToOrganizationTableMapper.getRightPrimaryKeys(getCompanyIdFromPK(
					pk), pk);
	...
	public List<com.liferay.portal.model.Organization> getOrganizations(
		...
		return userToOrganizationTableMapper.getRightBaseModels(getCompanyIdFromPK(
				pk), pk, start, end, orderByComparator);
	}
	...
	public boolean containsOrganization(long pk, long organizationPK) {
		return userToOrganizationTableMapper.containsTableMapping(getCompanyIdFromPK(
	...
	public void addOrganization(long pk, long organizationPK) {
		userToOrganizationTableMapper.addTableMapping(getCompanyIdFromPK(pk),
			pk, organizationPK);
	}
	...
	public void clearOrganizations(long pk) {
		userToOrganizationTableMapper.deleteLeftPrimaryKeyTableMappings(getCompanyIdFromPK(
				pk), pk);
	}
	...
	public void removeOrganization(long pk, long organizationPK) {
		userToOrganizationTableMapper.deleteTableMapping(getCompanyIdFromPK(pk),
			pk, organizationPK);
	}
	...
	public long[] getRolePrimaryKeys(long pk) {
		long[] pks = userToRoleTableMapper.getRightPrimaryKeys(getCompanyIdFromPK(
					pk), pk);
	...
	public List<com.liferay.portal.model.Role> getRoles(long pk, int start,
		...
		return userToRoleTableMapper.getRightBaseModels(getCompanyIdFromPK(pk),
			pk, start, end, orderByComparator);
	}
	...
	public boolean containsRole(long pk, long rolePK) {
		return userToRoleTableMapper.containsTableMapping(getCompanyIdFromPK(pk),
			pk, rolePK);
	}
	...
	public void addRole(long pk, long rolePK) {
		userToRoleTableMapper.addTableMapping(getCompanyIdFromPK(pk), pk, rolePK);
	}
	...
	public void addRole(long pk, com.liferay.portal.model.Role role) {
		userToRoleTableMapper.addTableMapping(getCompanyIdFromPK(pk), pk,
			role.getPrimaryKey());
	}
	...
	public void clearRoles(long pk) {
		userToRoleTableMapper.deleteLeftPrimaryKeyTableMappings(getCompanyIdFromPK(
				pk), pk);
	}
	...
	public void removeRole(long pk, long rolePK) {
		userToRoleTableMapper.deleteTableMapping(getCompanyIdFromPK(pk), pk,
			rolePK);
	}
	...
	public long[] getTeamPrimaryKeys(long pk) {
		long[] pks = userToTeamTableMapper.getRightPrimaryKeys(getCompanyIdFromPK(
					pk), pk);
	...
	public List<com.liferay.portal.model.Team> getTeams(long pk, int start,
		...
		return userToTeamTableMapper.getRightBaseModels(getCompanyIdFromPK(pk),
			pk, start, end, orderByComparator);
	}
	...
	public boolean containsTeam(long pk, long teamPK) {
		return userToTeamTableMapper.containsTableMapping(getCompanyIdFromPK(pk),
			pk, teamPK);
	}
	...
	public void addTeam(long pk, long teamPK) {
		userToTeamTableMapper.addTableMapping(getCompanyIdFromPK(pk), pk, teamPK);
	}
	...
	public void addTeam(long pk, com.liferay.portal.model.Team team) {
		userToTeamTableMapper.addTableMapping(getCompanyIdFromPK(pk), pk,
			team.getPrimaryKey());
	}
	...
	public void clearTeams(long pk) {
		userToTeamTableMapper.deleteLeftPrimaryKeyTableMappings(getCompanyIdFromPK(
				pk), pk);
	}
	...
	public void removeTeam(long pk, long teamPK) {
		userToTeamTableMapper.deleteTableMapping(getCompanyIdFromPK(pk), pk,
			teamPK);
	}
	...
	public long[] getUserGroupPrimaryKeys(long pk) {
		long[] pks = userToUserGroupTableMapper.getRightPrimaryKeys(getCompanyIdFromPK(
					pk), pk);
	...
	public List<com.liferay.portal.model.UserGroup> getUserGroups(long pk,
		...
		return userToUserGroupTableMapper.getRightBaseModels(getCompanyIdFromPK(
				pk), pk, start, end, orderByComparator);
	}
	...
	public boolean containsUserGroup(long pk, long userGroupPK) {
		return userToUserGroupTableMapper.containsTableMapping(getCompanyIdFromPK(
				pk), pk, userGroupPK);
	}
	...
	public void addUserGroup(long pk, long userGroupPK) {
		userToUserGroupTableMapper.addTableMapping(getCompanyIdFromPK(pk), pk,
			userGroupPK);
	}
	...
	public void clearUserGroups(long pk) {
		userToUserGroupTableMapper.deleteLeftPrimaryKeyTableMappings(getCompanyIdFromPK(
				pk), pk);
	}
	...
	public void removeUserGroup(long pk, long userGroupPK) {
		userToUserGroupTableMapper.deleteTableMapping(getCompanyIdFromPK(pk),
			pk, userGroupPK);
	}
	...
	*/
	protected long getCompanyIdFromPK(long pk) {
		...
		if (user == null) {
			throw new RuntimeException("The entity User with PK " + pk +
				" was not found");
		}
