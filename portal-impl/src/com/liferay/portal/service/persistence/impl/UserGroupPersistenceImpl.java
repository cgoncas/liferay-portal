...
public class UserGroupPersistenceImpl extends BasePersistenceImpl<UserGroup>
	...
	public long[] getGroupPrimaryKeys(long pk) {
		long[] pks = userGroupToGroupTableMapper.getRightPrimaryKeys(getCompanyId(
					pk), pk);
	...
	public List<com.liferay.portal.model.Group> getGroups(long pk, int start,
		...
		return userGroupToGroupTableMapper.getRightBaseModels(getCompanyId(pk),
	...
	public boolean containsGroup(long pk, long groupPK) {
		return userGroupToGroupTableMapper.containsTableMapping(getCompanyId(pk),
			pk, groupPK);
	}
	...
	public long[] getTeamPrimaryKeys(long pk) {
		long[] pks = userGroupToTeamTableMapper.getRightPrimaryKeys(getCompanyId(
					pk), pk);
	...
	public List<com.liferay.portal.model.Team> getTeams(long pk, int start,
		...
		return userGroupToTeamTableMapper.getRightBaseModels(getCompanyId(pk),
			pk, start, end, orderByComparator);
	}
	...
	public boolean containsTeam(long pk, long teamPK) {
		return userGroupToTeamTableMapper.containsTableMapping(getCompanyId(pk),
			pk, teamPK);
	}
	...
	public long[] getUserPrimaryKeys(long pk) {
		long[] pks = userGroupToUserTableMapper.getRightPrimaryKeys(getCompanyId(
					pk), pk);
	...
	public List<com.liferay.portal.model.User> getUsers(long pk, int start,
		...
		return userGroupToUserTableMapper.getRightBaseModels(getCompanyId(pk),
			pk, start, end, orderByComparator);
	}
	...
	public boolean containsUser(long pk, long userPK) {
		return userGroupToUserTableMapper.containsTableMapping(getCompanyId(pk),
			pk, userPK);
	}
