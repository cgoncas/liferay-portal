...
public class UserGroupPersistenceImpl extends BasePersistenceImpl<UserGroup>
	...
	protected UserGroup removeImpl(UserGroup userGroup) {
		...
		userGroupToGroupTableMapper.deleteLeftPrimaryKeyTableMappings(userGroup.getCompanyId(),
			userGroup.getPrimaryKey());
		userGroupToTeamTableMapper.deleteLeftPrimaryKeyTableMappings(userGroup.getCompanyId(),
			userGroup.getPrimaryKey());
		userGroupToUserTableMapper.deleteLeftPrimaryKeyTableMappings(userGroup.getCompanyId(),
			userGroup.getPrimaryKey());
	...
	public long[] getGroupPrimaryKeys(long pk) {
		...
		long[] pks = userGroupToGroupTableMapper.getRightPrimaryKeys(companyId,
				pk);
	...
	public List<com.liferay.portal.model.Group> getGroups(long pk, int start,
		...
		return userGroupToGroupTableMapper.getRightBaseModels(companyId, pk,
			start, end, orderByComparator);
	}
	...
	public boolean containsGroup(long pk, long groupPK) {
		...
		return userGroupToGroupTableMapper.containsTableMapping(companyId, pk,
			groupPK);
	}
	...
	public void addGroup(long pk, long groupPK) {
		userGroupToGroupTableMapper.addTableMapping(getCompanyId(pk), pk,
			groupPK);
	}
	...
	public void clearGroups(long pk) {
		userGroupToGroupTableMapper.deleteLeftPrimaryKeyTableMappings(getCompanyId(
				pk), pk);
	}
	...
	public void removeGroup(long pk, long groupPK) {
		userGroupToGroupTableMapper.deleteTableMapping(getCompanyId(pk), pk,
			groupPK);
	}
	...
	public void removeGroups(long pk, long[] groupPKs) {
		...
		for (long groupPK : groupPKs) {
			userGroupToGroupTableMapper.deleteTableMapping(companyId, pk,
				groupPK);
		}
	}
	...
	public long[] getTeamPrimaryKeys(long pk) {
		...
		long[] pks = userGroupToTeamTableMapper.getRightPrimaryKeys(companyId,
				pk);
	...
	public List<com.liferay.portal.model.Team> getTeams(long pk, int start,
		...
		return userGroupToTeamTableMapper.getRightBaseModels(companyId, pk,
			start, end, orderByComparator);
	}
	...
	public boolean containsTeam(long pk, long teamPK) {
		...
		return userGroupToTeamTableMapper.containsTableMapping(companyId, pk,
			teamPK);
	}
	...
	public void addTeam(long pk, long teamPK) {
		userGroupToTeamTableMapper.addTableMapping(getCompanyId(pk), pk, teamPK);
	}
	...
	public void addTeam(long pk, com.liferay.portal.model.Team team) {
		userGroupToTeamTableMapper.addTableMapping(getCompanyId(pk), pk,
			team.getPrimaryKey());
	}
	...
	public void clearTeams(long pk) {
		userGroupToTeamTableMapper.deleteLeftPrimaryKeyTableMappings(getCompanyId(
				pk), pk);
	}
	...
	public void removeTeam(long pk, long teamPK) {
		userGroupToTeamTableMapper.deleteTableMapping(getCompanyId(pk), pk,
			teamPK);
	}
	...
	public void removeTeams(long pk, long[] teamPKs) {
		...
		for (long teamPK : teamPKs) {
			userGroupToTeamTableMapper.deleteTableMapping(companyId, pk, teamPK);
		}
	}
	...
	public void removeTeams(long pk, List<com.liferay.portal.model.Team> teams) {
		...
		for (com.liferay.portal.model.Team team : teams) {
			userGroupToTeamTableMapper.deleteTableMapping(companyId, pk,
				team.getPrimaryKey());
		}
	}
	...
	public long[] getUserPrimaryKeys(long pk) {
		...
		long[] pks = userGroupToUserTableMapper.getRightPrimaryKeys(companyId,
				pk);
	...
	public List<com.liferay.portal.model.User> getUsers(long pk, int start,
		...
		return userGroupToUserTableMapper.getRightBaseModels(companyId, pk,
			start, end, orderByComparator);
	}
	...
	public boolean containsUser(long pk, long userPK) {
		...
		return userGroupToUserTableMapper.containsTableMapping(companyId, pk,
			userPK);
	}
	...
	public void addUser(long pk, long userPK) {
		userGroupToUserTableMapper.addTableMapping(getCompanyId(pk), pk, userPK);
	}
	...
	public void addUser(long pk, com.liferay.portal.model.User user) {
		userGroupToUserTableMapper.addTableMapping(getCompanyId(pk), pk,
			user.getPrimaryKey());
	}
	...
	public void clearUsers(long pk) {
		userGroupToUserTableMapper.deleteLeftPrimaryKeyTableMappings(getCompanyId(
				pk), pk);
	}
	...
	public void removeUser(long pk, long userPK) {
		userGroupToUserTableMapper.deleteTableMapping(getCompanyId(pk), pk,
			userPK);
	}
	...
	public void removeUsers(long pk, long[] userPKs) {
		...
		for (long userPK : userPKs) {
			userGroupToUserTableMapper.deleteTableMapping(companyId, pk, userPK);
		}
	}
	...
	public void removeUsers(long pk, List<com.liferay.portal.model.User> users) {
		...
		for (com.liferay.portal.model.User user : users) {
			userGroupToUserTableMapper.deleteTableMapping(companyId, pk,
				user.getPrimaryKey());
		}
	}
	...
	/**
	* Get the companyId associated with the user group
	*
	* @param pk the primary key of the user group
	*/
	protected long getCompanyId(long pk) {
		...
		if (userGroup == null) {
			throw new SystemException("The entity UserGroup with PK " + pk +
				" was not found");
		}
