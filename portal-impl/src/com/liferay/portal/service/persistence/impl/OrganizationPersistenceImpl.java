...
public class OrganizationPersistenceImpl extends BasePersistenceImpl<Organization>
	...
	public long[] getGroupPrimaryKeys(long pk) {
		long[] pks = organizationToGroupTableMapper.getRightPrimaryKeys(getCompanyId(
					pk), pk);
	...
	public List<com.liferay.portal.model.Group> getGroups(long pk, int start,
		...
		return organizationToGroupTableMapper.getRightBaseModels(getCompanyId(
	...
	public boolean containsGroup(long pk, long groupPK) {
		return organizationToGroupTableMapper.containsTableMapping(getCompanyId(
				pk), pk, groupPK);
	}
	...
	public void addGroup(long pk, long groupPK) {
		organizationToGroupTableMapper.addTableMapping(getCompanyId(pk), pk,
			groupPK);
	}
	...
	public void clearGroups(long pk) {
		organizationToGroupTableMapper.deleteLeftPrimaryKeyTableMappings(getCompanyId(
				pk), pk);
	}
	...
	public void removeGroup(long pk, long groupPK) {
		organizationToGroupTableMapper.deleteTableMapping(getCompanyId(pk), pk,
			groupPK);
	}
	...
	public long[] getUserPrimaryKeys(long pk) {
		long[] pks = organizationToUserTableMapper.getRightPrimaryKeys(getCompanyId(
					pk), pk);
	...
	public List<com.liferay.portal.model.User> getUsers(long pk, int start,
		...
		return organizationToUserTableMapper.getRightBaseModels(getCompanyId(pk),
	...
	public boolean containsUser(long pk, long userPK) {
		return organizationToUserTableMapper.containsTableMapping(getCompanyId(
				pk), pk, userPK);
	}
	...
	public void addUser(long pk, long userPK) {
		organizationToUserTableMapper.addTableMapping(getCompanyId(pk), pk,
			userPK);
	}
	...
	public void clearUsers(long pk) {
		organizationToUserTableMapper.deleteLeftPrimaryKeyTableMappings(getCompanyId(
				pk), pk);
	}
	...
	public void removeUser(long pk, long userPK) {
		organizationToUserTableMapper.deleteTableMapping(getCompanyId(pk), pk,
			userPK);
	}
