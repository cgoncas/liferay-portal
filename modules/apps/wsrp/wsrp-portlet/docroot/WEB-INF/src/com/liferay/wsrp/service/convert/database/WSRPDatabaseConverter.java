...
package com.liferay.wsrp.service.convert.database;
 ...
 * @generated
 */
public class WSRPDatabaseConverter implements DatabaseConverter {
	@Override
	...
	private List<Class<?extends BaseModel<?>>> _getModels() {
		...
		models.add(WSRPConsumerImpl.class);
		models.add(WSRPConsumerPortletImpl.class);
		models.add(WSRPProducerImpl.class);
