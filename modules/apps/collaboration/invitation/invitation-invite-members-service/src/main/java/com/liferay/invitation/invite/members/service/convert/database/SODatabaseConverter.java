...
package com.liferay.invitation.invite.members.service.convert.database;
 ...
 * @generated
 */
public class SODatabaseConverter implements DatabaseConverter {
	@Override
	...
	private List<Class<?extends BaseModel<?>>> _getModels() {
		...
		models.add(MemberRequestImpl.class);
