...
package com.liferay.social.privatemessaging.service.convert.database;
 ...
 * @generated
 */
public class PMDatabaseConverter implements DatabaseConverter {
	@Override
	...
	private List<Class<?extends BaseModel<?>>> _getModels() {
		...
		models.add(UserThreadImpl.class);
