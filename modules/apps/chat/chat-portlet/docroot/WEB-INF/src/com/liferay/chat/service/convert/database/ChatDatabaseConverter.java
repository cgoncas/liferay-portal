...
package com.liferay.chat.service.convert.database;
 ...
 * @generated
 */
public class ChatDatabaseConverter implements DatabaseConverter {
	@Override
	...
	private List<Class<?extends BaseModel<?>>> _getModels() {
		...
		models.add(EntryImpl.class);
		models.add(StatusImpl.class);
