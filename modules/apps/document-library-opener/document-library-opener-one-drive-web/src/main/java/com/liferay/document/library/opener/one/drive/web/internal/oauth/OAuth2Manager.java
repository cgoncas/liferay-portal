...
public class OAuth2Manager {
	...
	private OAuth20Service _getOAuth20Service(
		...
		try (OAuth20Service oAuth20Service = new ServiceBuilder(
				dlOneDriveCompanyConfiguration.clientId()).apiSecret(
					dlOneDriveCompanyConfiguration.clientSecret()).callback(
						redirectURL).withScope(
							"https://graph.microsoft.com/.default").apiKey(
								dlOneDriveCompanyConfiguration.clientId()).
									build(
										MicrosoftAzureActiveDirectory20Api.
											custom(
												dlOneDriveCompanyConfiguration.
													tenant()))) {
