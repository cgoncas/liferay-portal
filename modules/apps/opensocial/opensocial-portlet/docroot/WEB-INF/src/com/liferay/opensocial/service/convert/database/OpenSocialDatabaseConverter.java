...
package com.liferay.opensocial.service.convert.database;
 ...
 * @generated
 */
public class OpenSocialDatabaseConverter implements DatabaseConverter {
	@Override
	...
	private List<Class<?extends BaseModel<?>>> _getModels() {
		...
		models.add(GadgetImpl.class);
		models.add(OAuthConsumerImpl.class);
		models.add(OAuthTokenImpl.class);
