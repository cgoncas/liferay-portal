...
public class MediaOjectApioTest {
	...
	public void testCreateDocumentInFolder() {
		...
		_folderHref = ApioClientBuilder.given(
		).basicAuth(
			"test@liferay.com", "test"
		).header(
			"Accept", "application/hal+json"
			...
			"{\"name\":\"My folder testCreateDocumentInFolder\"}"
		).when(
		).post(
			foldersHref
		).then(
		...
		String documentsHref = ApioClientBuilder.given(
			...
			"_embedded.Folder.find {it.name == 'My folder " +
				"testCreateDocumentInFolder'}._links.documents.href"
		);
	...
	public void testGetDocumentsInFolder() {
		String foldersHrefURL = ApioClientBuilder.given(
		).basicAuth(
			"test@liferay.com", "test"
		).header(
			"Accept", "application/hal+json"
		...
		_folderHref = ApioClientBuilder.given(
			...
			"{\"name\":\"My folder testGetDocumentsInFolder\"}"
		).when(
		).post(
			foldersHrefURL
		).then(
		...
		String documentsHref = ApioClientBuilder.given(
			...
			"_embedded.Folder.find {it.name == 'My folder " +
				"testGetDocumentsInFolder'}._links.documents.href"
		);
	...
	@Test
	public void testUpdateDocumentIsNotSupported() {
		String documentsHref = ApioClientBuilder.given(
		).basicAuth(
			"test@liferay.com", "test"
		).header(
		...
		ApioClientBuilder.given(
			...
			"binaryFile", _readFile("document-updated.pdf")
		).when(
		).put(
			_documentHref
		).then(
