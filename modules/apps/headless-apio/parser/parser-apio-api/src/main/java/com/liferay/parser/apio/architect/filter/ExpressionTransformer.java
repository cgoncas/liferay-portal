...
/**
 * <code>ExpressionTransformer</code> transforms a Expression into a T type.
 *
 * @author David Arques
 * @review
 */
public interface ExpressionTransformer<T> {

	/**
	 * Transform a expression into a T type given a locale and a entityModel.
	 *
