...
public class StructuredContentApioTest {
	...
	@Test
	public void testDefaultTitleIsDisplayedWhenLocaleDERequestedIsNotAvailable()
		throws Exception {
	...
	@Test
	public void testDefaultTitleIsDisplayedWhenLocaleESRequestedIsNotAvailable()
		throws Exception {
		...
		Assert.assertTrue(
			titles.contains(
				StructuredContentApioTestBundleActivator.
					TITLE3_LOCALE_DEFAULT));
	}

	@Test
	public void testDefaultTitleIsDisplayedWhenLocaleFRRequestedIsNotAvailable()
		throws Exception {
		...
		headersMap.put("Accept-Language", "fr-FR");
	...
	public void testLocalizedTitleIsDisplayedWhenLocaleFRRequestedIsAvailable()
		...
		Assert.assertTrue(
			titles.contains(
				StructuredContentApioTestBundleActivator.TITLE2_LOCALE_FR));

		Assert.assertTrue(
			titles.contains(
				StructuredContentApioTestBundleActivator.TITLE3_LOCALE_FR));
	}
