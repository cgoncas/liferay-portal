...
public class StructuredContentApioTestBundleActivator
	...
	public static final String TITLE_DATE_FIELD_LOCALE_US =
		StructuredContentApioTestBundleActivator.class.getSimpleName() +
			"TitleDateField_us";

	public static final String TITLE_DECIMAL_FIELD_LOCALE_US =
		StructuredContentApioTestBundleActivator.class.getSimpleName() +
			"TitleDecimalField_us";

	public static final String TITLE_DOCUMENTS_AND_MEDIA_FIELD_LOCALE_US =
		StructuredContentApioTestBundleActivator.class.getSimpleName() +
	...
	public static final String TITLE_HTML_FIELD_LOCALE_US =
		StructuredContentApioTestBundleActivator.class.getSimpleName() +
			"TitleHtmlField_us";

	public static final String TITLE_IMAGE_FIELD_LOCALE_US =
		StructuredContentApioTestBundleActivator.class.getSimpleName() +
			"TitleImageField_us";

	public static final String TITLE_INTEGER_FIELD_LOCALE_US =
		StructuredContentApioTestBundleActivator.class.getSimpleName() +
	...
	public static final String TITLE_NUMBER_FIELD_LOCALE_US =
		StructuredContentApioTestBundleActivator.class.getSimpleName() +
			"TitleNumberField_us";

	public static final String TITLE_RADIO_FIELD_LOCALE_US =
		StructuredContentApioTestBundleActivator.class.getSimpleName() +
			"TitleRadioField_us";
	...
	public static final String TITLE_WEB_CONTENT_FIELD_LOCALE_US =
		StructuredContentApioTestBundleActivator.class.getSimpleName() +
			"TitleWebContentField_us";
	...
	private void _prepareDataForDataTypesTests(User user, Group group)
		...
		_addJournalArticle(
			user, group, "test-journal-date-field", TITLE_DATE_FIELD_LOCALE_US);

		_addJournalArticle(
			user, group, "test-journal-decimal-field",
			TITLE_DECIMAL_FIELD_LOCALE_US);
		...
		_addJournalArticle(
			user, group, "test-journal-html-field", TITLE_HTML_FIELD_LOCALE_US);

		_addJournalArticle(
			user, group, "test-journal-image-field",
			TITLE_IMAGE_FIELD_LOCALE_US);
		...
		_addJournalArticle(
			user, group, "test-journal-number-field",
		...
		_addJournalArticle(
			user, group, "test-journal-text-box-field",
			TITLE_TEXT_BOX_FIELD_LOCALE_US);

		_addJournalArticle(
			user, group, "test-journal-web-content-field",
			TITLE_WEB_CONTENT_FIELD_LOCALE_US);
	}
