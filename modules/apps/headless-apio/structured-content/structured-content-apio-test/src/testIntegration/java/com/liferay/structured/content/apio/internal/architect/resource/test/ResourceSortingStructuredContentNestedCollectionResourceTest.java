...
public class ResourceSortingStructuredContentNestedCollectionResourceTest
	...
	public void testGetPageItemsSortByCheckboxStructureFieldAsc()
		...
		PageItems<JournalArticle> pageItems = getPageItems(
			...
			getThemeDisplay(_group, Locale.US), Filter.emptyFilter(),
			new Sort(
				sortParser.parse(
	...
	public void testGetPageItemsSortByTitleAsc() throws Throwable {
		...
		PageItems<JournalArticle> pageItems = getPageItems(
			PaginationRequest.of(10, 1), _group.getGroupId(), _acceptLanguage,
			getThemeDisplay(_group, Locale.US), Filter.emptyFilter(),
			new Sort(sortParser.parse("title:asc")));
	...
	public void testGetPageItemsSortByTitleAscWithDifferentDefaultLocale()
		...
		stringMap1.put(Locale.US, "titleZ");
	...
	public void testGetPageItemsSortByTitleDefault() throws Throwable {
		...
		stringMap1.put(Locale.US, "title B");
		...
		stringMap2.put(Locale.US, "title A");
		...
		PageItems<JournalArticle> pageItems = getPageItems(
			PaginationRequest.of(10, 1), _group.getGroupId(), _acceptLanguage,
			getThemeDisplay(_group, Locale.US), Filter.emptyFilter(),
			new Sort(sortParser.parse("title")));
	...
	public void testGetPageItemsSortByTitleDesc() throws Throwable {
		...
		stringMap1.put(Locale.US, "title A");
		...
		stringMap2.put(Locale.US, "title B");
		...
		PageItems<JournalArticle> pageItems = getPageItems(
			PaginationRequest.of(10, 1), _group.getGroupId(), _acceptLanguage,
			getThemeDisplay(_group, Locale.US), Filter.emptyFilter(),
			new Sort(sortParser.parse("title:desc")));
