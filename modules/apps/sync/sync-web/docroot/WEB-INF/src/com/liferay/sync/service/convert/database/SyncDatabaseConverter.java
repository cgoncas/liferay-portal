...
package com.liferay.sync.service.convert.database;
 ...
 * @generated
 */
public class SyncDatabaseConverter implements DatabaseConverter {
	@Override
	...
	private List<Class<?extends BaseModel<?>>> _getModels() {
		...
		models.add(SyncDeviceImpl.class);
		models.add(SyncDLFileVersionDiffImpl.class);
		models.add(SyncDLObjectImpl.class);
