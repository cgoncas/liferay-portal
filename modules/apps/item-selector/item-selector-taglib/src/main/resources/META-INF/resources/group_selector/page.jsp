...
boolean isRepositories = ParamUtil.getBoolean(request, "isRepositories");
%>

<div class="container-fluid-1280">
	<div class="btn-group" role="group">
		<a class="btn btn-secondary <%= !isRepositories ? "active" : StringPool.BLANK %>" href="<%= sitesURL %>"><liferay-ui:message key="sites" /></a>
		<a class="btn btn-secondary <%= isRepositories? "active" : StringPool.BLANK %>" href="<%= repositoriesURL %>"><liferay-ui:message key="repositories" /></a>
	</div>
</div>
