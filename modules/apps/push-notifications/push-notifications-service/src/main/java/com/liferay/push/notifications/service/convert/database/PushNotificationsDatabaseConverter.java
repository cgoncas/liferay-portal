...
package com.liferay.push.notifications.service.convert.database;
 ...
 * @generated
 */
public class PushNotificationsDatabaseConverter implements DatabaseConverter {
	@Override
	...
	private List<Class<?extends BaseModel<?>>> _getModels() {
		...
		models.add(PushNotificationsDeviceImpl.class);
