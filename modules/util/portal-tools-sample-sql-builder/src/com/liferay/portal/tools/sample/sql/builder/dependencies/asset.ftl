...
<#list dataFactory.assetTagStatsModels as assetTagStatsModel>
	insert into AssetTagStats values (${assetTagStatsModel.companyId}, ${assetTagStatsModel.tagStatsId}, ${assetTagStatsModel.tagId}, ${assetTagStatsModel.classNameId}, ${assetTagStatsModel.assetCount});
</#list>