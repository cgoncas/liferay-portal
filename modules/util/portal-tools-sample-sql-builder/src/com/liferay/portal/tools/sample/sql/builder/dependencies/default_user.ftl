...
<#list groupIds as groupId>
	...
	insert into BlogsStatsUser values (${blogsStatsUserModel.companyId}, ${blogsStatsUserModel.statsUserId}, ${blogsStatsUserModel.groupId}, ${blogsStatsUserModel.userId}, ${blogsStatsUserModel.entryCount}, '${dataFactory.getDateString(blogsStatsUserModel.lastPostDate)}', ${blogsStatsUserModel.ratingsTotalEntries}, ${blogsStatsUserModel.ratingsTotalScore}, ${blogsStatsUserModel.ratingsAverageScore});

	<#assign mbStatsUserModel = dataFactory.newMBStatsUserModel(groupId)>

	insert into MBStatsUser values (${mbStatsUserModel.companyId}, ${mbStatsUserModel.statsUserId}, ${mbStatsUserModel.groupId}, ${mbStatsUserModel.userId}, ${mbStatsUserModel.messageCount}, '${dataFactory.getDateString(mbStatsUserModel.lastPostDate)}');
</#list>