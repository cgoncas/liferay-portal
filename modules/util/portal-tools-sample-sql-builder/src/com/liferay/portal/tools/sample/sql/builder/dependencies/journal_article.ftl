...
<#list journalArticlePageCounts as journalArticlePageCount>
	...
	<#list journalArticleCounts as journalArticleCount>
		...
		insert into JournalArticleResource values (${journalArticleResourceModel.companyId}, '${journalArticleResourceModel.uuid}', ${journalArticleResourceModel.resourcePrimKey}, ${journalArticleResourceModel.groupId}, '${journalArticleResourceModel.articleId}');
