...
<#list wikiNodeModels as wikiNodeModel>
	...
	<#list wikiPageModels as wikiPageModel>
		...
		insert into WikiPageResource values (${wikiPageResourceModel.companyId}, '${wikiPageResourceModel.uuid}', ${wikiPageResourceModel.resourcePrimKey}, ${wikiPageResourceModel.groupId}, ${wikiPageResourceModel.nodeId}, '${wikiPageResourceModel.title}');
