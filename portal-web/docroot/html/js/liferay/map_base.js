		...
		Base.prototype = {
			initializer: function() {
				...
				if (!latitude || !longitude) {
					Liferay.Util.getGeolocation(A.bind(instance._initializeMap, instance));
				}
				else {
			...
			_initializeMap: function(latitude, longitude) {
				...
				instance._mainMarker = instance.addMarker();

				instance._bindMapUIMB();

				if (instance.get(STR_GEOCODE)) {
