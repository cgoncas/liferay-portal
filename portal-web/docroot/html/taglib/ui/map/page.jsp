...
String latitude = GetterUtil.getString((String)request.getAttribute("liferay-ui:map:latitude"));
String longitude = GetterUtil.getString((String)request.getAttribute("liferay-ui:map:longitude"));
...
<aui:script use="<%= modules %>">
	...
	Liferay.component(
		'<%= name %>',
		new Liferay["<%= mapsApiProvider %>Map"](mapConfig).render()
	);
</aui:script>